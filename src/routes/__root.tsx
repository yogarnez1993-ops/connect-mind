...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Conectamente — Terapia psicológica online en Perú" },
      {
        name: "description",
        content:
          "Conectamente conecta pacientes con psicólogos colegiados en Perú: sesiones online, paquetes y seguimiento.",
      },
      { property: "og:title", content: "Conectamente" },
      {
